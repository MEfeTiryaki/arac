...
void AracEKF::initilize(ros::NodeHandle* nh)
{
  /*
   * X_k = [ x_k
   *       , y_k
...
void AracEKF::advance(double dt)
{
...
void AracEKF::initilizeSubscribers()
{
...
void AracEKF::publishVisualization()
{
...
void  AracEKF::publishEstimatedState()
{
...
void AracEKF::getImuMsg(sensor_msgs::Imu msg)
{
  imuMsg_ = msg;
}

void AracEKF::getSensorData()
{
...
void AracEKF::getInput()
{
  ...
  U_[1] = model_.getWheel()[2]->getDesiredState().getAngularVelocityInWorldFrame()[2];
}
void AracEKF::pStep()
{
